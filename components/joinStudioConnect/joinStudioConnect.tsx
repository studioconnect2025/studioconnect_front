...
export default function JoinStudioConnect() {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center">
      {/* Header */}
      <div className="w-full bg-sky-800 text-white py-12 text-center">
        <h1 className="text-3xl md:text-4xl font-bold">Únete a StudioConnect</h1>
        ...
        <div className="flex justify-center mt-6">
          <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center">
            <PiHandHeartFill  size={60} className="text-sky-700 ml-1 " />
          </div>
        </div>
      </div>

      {/* Options */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl w-full px-6 py-16">
        {/* Para músicos */}
        <div className="bg-white shadow-md rounded-2xl p-6 flex flex-col items-center text-center hover:shadow-2xl transition gap-3">
          ...
          <button className="bg-sky-800 text-white px-6 py-2 rounded-lg hover:bg-blue-900 transition">
        ...
        <div className="bg-white shadow-md rounded-2xl p-6 flex flex-col items-center text-center hover:shadow-2xl transition gap-3">
          ...
          <button className="bg-sky-800 text-white px-6 py-2 rounded-lg hover:bg-blue-900 transition mt-8">
