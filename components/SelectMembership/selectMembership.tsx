import { FaCheck, FaMobileAlt, FaLock, FaHeadset, FaChartBar, FaCalendarCheck, FaCreditCard, FaMedal } from "react-icons/fa";
    ...
    <section className="w-full bg-gray-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white  border-4 hover:border-black rounded-xl shadow-sm hover:shadow-xl relative text-center">
            ...
            <div className="p-6 flex flex-col items-center space-y-6">
              ...
              <button className="bg-sky-700 text-white py-2 px-6 text-sm sm:text-base md:text-lg rounded-xl w-full sm:w-auto hover:bg-black transition-transform duration-300 ease-in-out hover:scale-110">
                Empezar
              </button>
            </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 pb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-center  ">
          {[
            { title: "Reserva inteligente", desc: "Sistema de programación inteligente con prevención de conflictos", icon: <FaCalendarCheck /> },
            { title: "Analíticas", desc: "Información detallada sobre el rendimiento de su estudio", icon: <FaChartBar /> },
            { title: "Procesamiento de pagos", desc: "Manejo seguro de pagos con múltiples opciones", icon: <FaCreditCard /> },
            { title: "App mobile", desc: "Administra tu estudio sobre la marcha", icon: <FaMobileAlt /> },
            { title: "24/7 Support", desc: "Asistencia las 24 horas cuando la necesite", icon: <FaHeadset /> },
            { title: "Seguridad", desc: "Seguridad de nivel empresarial para sus datos", icon: <FaLock /> },
          ].map((item, i) => (
            <div key={i} className="flex flex-col items-center">
              <div className="w-16 h-16 bg-sky-100 text-sky-700 
                flex items-center justify-center 
                rounded-2xl mb-3 text-3xl 
