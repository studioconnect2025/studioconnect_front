...
export default function LoginPage({ onClose }: LoginPageProps) {
  ...
  const handleGoogleLogin = () => {
    // Cerrar modal si existe antes de redirigir
    onClose?.();
    loginWithGoogle();
  };
        ...
        <div className="rounded-b-xl bg-white shadow-md p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative mt-1">
                <input
                  ...
                  disabled={loading}
                  {...emailAria}
                  className={`block w-full rounded-md border px-3 py-2 shadow-sm text-black focus:border-sky-600 focus:ring-sky-600 sm:text-sm disabled:opacity-50 disabled:cursor-not-allowed ${
                    touchedEmail && emailErr
                      ? "border-red-500"
                      : "border-gray-300"
                  }`}
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <button
                  ...
                  disabled={loading}
                  className="absolute right-2 top-1/2 -translate-y-1/2 rounded p-1 text-gray-500 hover:text-gray-700 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            <div className="flex items-center justify-between">
              <label className="inline-flex items-center gap-2">
                <input
                  ...
                  disabled={loading}
                  className="h-4 w-4 rounded border-gray-300 text-sky-600 focus:ring-sky-600 disabled:opacity-50 disabled:cursor-not-allowed"
                />
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-2 px-4 rounded-md border border-gray-300 bg-white text-gray-700 hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-white"
            >
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <Link
              ...
              onClick={() => {
                onClose?.(); // Cierra el modal al navegar al registro
              }}
