...
export function SectionTitle({ children }: { children: ReactNode }) {
  return (
    <h3 className="text-2xl md:text-base font-semibold text-gray-700 mb-3">{children}</h3>
  );
}
...
export default function RegisterPage() {
  ...
  const servicesList = ["Sala de grabación", "Sala de ensayo", "Sala de producción", "Cafetería", "Estacionamiento"];
              ...
              <Form className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <Field as="textarea" name="description" placeholder="Describe tu estudio..."
                  ...
                  <div>
                    ...
                    <Field as="select" name="studioType" className="w-full cursor-pointer border border-gray-300 rounded-lg bg-white px-3 py-2 text-sm text-gray-800 shadow-sm">
                      ...
                      {studioTypes.map((type) => <option key={type.value} value={type.value}>{type.label}</option>)}
                    </Field>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {servicesList.map((s) => <Checkbox key={s} name="services" value={s} label={s} />)}
                  </div>
                  ...
                  <div className="border-2 border-dashed border-sky-600 rounded-lg p-4 text-center cursor-pointer hover:bg-gray-50">
                    <input id="comercialRegister" name="comercialRegister" type="file"
                      accept="application/pdf,image/*"
                      className="hidden"
                      onChange={(event) => setFieldValue("comercialRegister", event.currentTarget.files?.[0])} />
